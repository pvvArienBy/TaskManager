...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addFormatters(FormatterRegistry registry) {
        ...
        registry.addConverter(new ReportCreateDtoToEntityConverter());
        registry.addConverter(new ReportEntityToDtoConverter());
        registry.addConverter(new PageEntityToPageDtoConverter(new ReportEntityToDtoConverter()));
        registry.addConverter(new ParamDTOToEntityConverter());
        registry.addConverter(new ParamEntityToDtoConverter());
    }
}
